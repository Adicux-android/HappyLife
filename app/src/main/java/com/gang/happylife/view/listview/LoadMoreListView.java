...
public class LoadMoreListView extends ListView {
    ...
    private RelativeLayout rootFootView ;
    // 加载更多视图（底部视图）
    ...
    private void init(Context context, AttributeSet attrs) {
         ...
         * 底部
         */
        footView = inflater.inflate(R.layout.load_more_list_view_foot, this, false);
        ...
        rootFootView = new RelativeLayout(getContext());
    ...
    public void setOnGetMoreListener(OnGetMoreListener getMoreListener) {
        ...
        if (!addFooterFlag) {
            addFooterFlag = true;
            this.addFooterView(rootFootView);
        }
    }
